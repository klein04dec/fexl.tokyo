...
オーバーロードの発動後は、レイジでほぼ常時ゲージが3本溜まった状態となり、メーターパワーの攻撃力アップと、ディスラプトのスーパーコンボダメージ50%アップが適用される。なお、スーパーコンボを出すとディスラプトによりゲージが空になるため、スーパーコンボにはメーターパワーの効果が適用されない。スーパーコンボ以外のダメージは20%アップ、スーパーコンボは50%アップとなる。ミラクルのマンモス（攻撃力35%アップ）に比べれば少し見劣りするように見えるが、レイジでゲージが無限になっていることを踏まえれば、十分すぎる火力があると言える。
...
- ドクトリンダーク
    - ガードさせやすいボムがあり、ワイヤーがヒットした後のコンボから必殺技に繋げて2カウントにできる
    - 3ゲージコンボは火力が低く、ディスラプトでカバーできる（★★ダメージ確認）
- はやて、プルム
    - 必殺技をガードされても反撃を受けにくい
    - 3ゲージコンボの火力の低さを、ディスラプトでカバーできる
