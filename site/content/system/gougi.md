...
- リバーサルを2回行うと発動
- リバーサルを行うたびにカウントが1ずつ増える。カウント1につきリバーサルのゲージ増加量が★増える
- カウント★でゲージ1本、★でゲージ全回復する
...
- スーパーコンボからスーパーコンボへのスーパーキャンセルを2回行うと発動
    - スーパーコンボは★ヒット、ガード、空振りなど問わない
    - 一度のコンボでスーパーコンボを3回繋ぐと、それだけで発動する★
- スーパーコンボゲージ★につきダメージが★%アップする
- スーパーコンボを3本繋ぐよりもヒット数による補正が小さくなるため、コンボとしてのダメージは高くなる
- 投げスパコンだと★
- スーパーコンボをガードされた際のフォローのしようがないため、少し使いづらい
