...
1. スーパーキャンセル
    - 必殺技やスーパーコンボをヒットさせるかガードさせた場合、いつでもスーパーコンボでキャンセルできる
        - 空振りした場合はキャンセルできない
        - たとえば魔龍裂光をガードさせた後、相手が着地際を攻撃しそうなところで神鬼発動改を出して攻撃を潰すことができる
2. ファーストアタック、投げ抜け、リバーサルでそれぞれゲージが溜まる
    - 特にファーストアタックはゲージが30（ゲージ1本は50）溜まるので大切
3. ボタンの入力は4F程度の先行入力が効く
...
- レバーを上方向に入れてから3Fの間に攻撃を食らうと、地上ヒットとなる
    - ダランだけは5Fまで地上判定
- レバーを上方向に入れてから4F以降に攻撃を食らうと、空中ヒットとなる
    - ダランだけは6Fから空中判定
...
- 通常の起き上がりでは、投げに対する無敵が7Fあるが★★要再確認★★、受け身を取ると1Fのみになってしまう
...
- 投げ抜けの弱Pと弱Kのズラし押しは、★★Fまで許容されている

##### 小パングラップ / 小足グラップ

- 弱Pと弱Kをズラし押しすることで、弱攻撃と投げ抜け（＝グラップ）の自動二択をする防御テクニック
    - 投げられていた場合は投げ抜けとなる
    - そうでない場合は弱Pや弱Kが出る
...
- 暗転前にニュートラルモーション（前後への歩きを含む）だった場合に限り、強制停止中にガードすることはできる
    - 過去のEXシリーズでは同じ状況でもガードができなかった。EX2シリーズでEXCELの発動だけが可能だった
...
- ボタンを押してから7F以内であれば、必殺技での空キャンセルが可能
- 発生が★★F以内の通常技、特殊技は、スーパーコンボでキャンセル可能
- ボタンを押してから★★F以内であれば、スーパーコンボでの空キャンセルが可能
- このゲームには、弱攻撃の連打による連打キャンセルは存在しない

##### 必殺技 / スーパーコンボのスーパーキャンセル

- 必殺技、ハードアタック、スーパーコンボは相手にヒットかガードさえさせれば、どのタイミングでもキャンセル可能
...
- チェーンコンボで出した技は、空キャンセルができない
    - たとえばシラセで「しゃがみ弱K - 立ち大P - 6大Kを空キャンセルして肘激崩」というようなことはできない
...
空中コンボを成立させるうえで、空中でのやられ状態を把握しておく必要があるため、ここで説明します。

- 空中やられ
    - 空中の相手に通常技やジャンプ攻撃を当てた状態
    - 相手は着地すると立ってすぐに動けるようになる
- 空中ダウン
    - 空中の相手に必殺技を当てた場合や、地上コンボから浮かせた場合のダウン
    - 相手は着地するとダウンする。受け身可能
- 大足払いダウン
    - しゃがみ強Kを当てた後のダウン
    - 相手は着地するとダウンする。受け身可能
...
- 空中にふきとんだ相手は一定時間だけ食らい判定が残っているため、打撃技などで追撃することができる
- 空中でのやられ状態と、判定が残っているフレーム数は次の通り
    - 空中やられ
        - 1Hit後は相手が地上に着地するまで判定
        - 2Hit後は★★F
        - 3Hit後以降は★★F
        - 例) シラセ: 対空立ち中P - (キャンセルせず)掌燐撃
    - 空中ダウン
        - 27F
        - 例: アレン: (トリプルブレイクの後) ダッシュ中K - 強K - 6中K - ファイヤーフォース
    - 大足払いダウン
        - 7F
