...
ジャンプから軌道を変える技や二段ジャンプなど、ジャンプからの攻めが多彩なキャラ。地上での切り返し技も備えている。
...
|技 |解説|
|---|----|
|ドリル＊プルス(地上)|錐揉み回転しながら低空ドロップキックの要領で突っ込む突進技。ガードされると隙が大きいため、コンボとして利用する|
|ドリル＊プルス(空中)|上記の空中版。出すボタンで突進角度が変わる。弱：30度、中：45度、強：60度。地面すれすれでガードさせれば有利となる、プルムの主力であり生命線となる技|
...
|技 |解説|
|---|----|
|プラエク＊ラーム|その場でスピンして蹴りを繰り出して風を巻き上げながら上昇する。無敵も長い上に背後まで判定があるので、切り返しや対空で使っていこう。コンボ用にも使える|
|レスアル＊カーナ|ジャンプかかと落とし４連の後プルム＊キックで〆る。ガードされると隙が大きいが、ダメージが大きいためコンボ用に利用する|
|カイト＊ウィンド|空中からしゃがんだダランくらいの竜巻を発生させて攻撃する。プルム唯一の飛び道具。追撃や必殺技をガードされた際のフォローに使う。技後のモーションが大きいので注意|
