...
{{% panel theme="default" header="(88) （画面端）しゃがみ弱K→しゃがみ中K→肘激崩→掌撃破→連昇激→ダッシュ立ち中K→大P→連昇激→ダッシュ立ち中K→大P→刈蹴(6強K)→連昇激→くだりJ強K→立ち強K" %}}画面端で入りやすい空中コンボ。ヒット数の都合で連昇激後の追い打ちの内容が少し変わる。{{% /panel %}}
